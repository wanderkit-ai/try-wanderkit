...
## What this is
Creator-economy platform for travel influencers to sell curated group trips ("drops"). Full-stack Next.js 14 app with Supabase, Prisma 7, Stripe, Resend, and Claude AI.
...
- **Email**: Resend
- **AI**: Anthropic Claude API (streaming itinerary generation)
